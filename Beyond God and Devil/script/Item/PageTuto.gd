...
func _process(delta):
	if activer :
		...
		match discution:
			1:
					dialogue.text = "You shall see a lot of obstacle on your path youngling, but remember that there is always a way to overpass them"
			2: 
				dialogue.text = "Remember youngling, remember the way we teach you to move and jump (arrow key)"
